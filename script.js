...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function performSearch(query) {
        ...
        const searchableContent = [
            { title: 'Projects', url: 'Projects.html', keywords: ['code', 'development', 'portfolio'] },
            { title: 'About', url: 'About.html', keywords: ['bio', 'background', 'skills'] },
            { title: 'Docs', url: 'Docs.html', keywords: ['documentation', 'guide', 'reference'] },
            { title: 'New', url: 'New.html', keywords: ['upcoming', 'future', 'ideas'] }
        ];
        ...
        // If results found, redirect to the first matching page
        if (results.length > 0) {
