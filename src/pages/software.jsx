...
export default function Software() {
  ...
  return <main className="software-page">
    ...
    <section className="software-closing"><p className="software-kicker">COMING TO WINDOWS FIRST</p><h2>Make room for<br />the work itself.</h2><button type="button" onClick={openNotice}>Get early access <span>→</span></button></section>
